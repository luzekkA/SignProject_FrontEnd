import { validid, validURL, validLowerCase, validUpperCase, validAlphabets } from '@/utils/validate.js'
describe('Utils:validate', () => {
  it('validid', () => {
    expect(validid('admin')).toBe(true)
    expect(validid('editor')).toBe(true)
    expect(validid('xxxx')).toBe(false)
  })
  it('validURL', () => {
